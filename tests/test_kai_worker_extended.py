...
from kai_exceptions import EmbeddingError, Neo4jConnectionError
from kai_worker import KaiResponse, KaiWorker
...
class TestKaiWorkerExecutePlan:
    ...
    def test_execute_plan_with_empty_subgoals(self, kai_worker_with_mocks):
        ...
        from component_5_linguistik_strukturen import GoalType, MainGoal
