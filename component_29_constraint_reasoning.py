...
class Variable:
    ...
    def __post_init__(self):
        """Store original domain for reset operations"""
...
class ConstraintSolver:
    ...
    def __init__(
        self, use_ac3: bool = True, use_mrv: bool = True, use_lcv: bool = True
    ):
        """
        Initialize solver with optional heuristics.
    ...
    def ac3(self, problem: ConstraintProblem) -> bool:
        """
        ...
        Args:
            problem: ConstraintProblem to make arc consistent
