...
class GraphTraversal:
    ...
    def __init__(self, netzwerk, use_dynamic_confidence: bool = True):
        ...
        if self.use_dynamic_confidence:
            try:
                ...
                logger.info("GraphTraversal: Dynamic Confidence System aktiviert")
            except Exception as e:
                logger.warning(
                    f"GraphTraversal: Fehler beim Initialisieren von Dynamic Confidence: {e}"
                )
    ...
    def find_transitive_relations(
        ...
        def dfs(
            ...
            for target_info in targets_with_conf:
                ...
                edge_confidence = self._calculate_dynamic_confidence(
                    subject=current,
    ...
    def _calculate_dynamic_confidence(
        ...
        """
        Berechnet dynamische Confidence für eine Edge.
        ...
        Sonst wird die Base Confidence zurückgegeben.
        ...
        Args:
            ...
            timestamp: Zeitstempel der Fact-Erstellung (für Decay)
        ...
        try:
            # Konvertiere timestamp von Neo4j Format falls nötig
            if timestamp is not None and not isinstance(timestamp, datetime):
                # Neo4j gibt manchmal Millisekunden seit Epoch zurück
