...
class ProductionSystemTab(QWidget):
    """Tab für Production System Visualisierung und Statistiken (PHASE 8.1 + PHASE 9)"""
    ...
    def __init__(self, parent=None, netzwerk=None):
        ...
        Args:
            ...
            netzwerk: Optional KonzeptNetzwerk für Neo4j-Stats (PHASE 9)
        """
        super().__init__(parent)
    ...
    def load_production_rules(self):
        """Lädt alle verfügbaren Produktionsregeln."""
        try:
    ...
    def sync_neo4j_stats(self):
        ...
        try:
            ...
            # Erstelle Dict für schnellen Lookup
    ...
    def init_ui(self):
        ...
        # PHASE 9: Horizontales Layout für Stats + Refresh Button
        ...
        self.refresh_button.setToolTip("Lädt Statistiken aus Neo4j neu")
        ...
        if self.netzwerk:
            ...
            self.neo4j_status_label.setText("⚠️ Neo4j nicht verbunden (Stats nicht persistiert)")
        ...
        # Regeln nach Kategorie sortieren und hinzufügen
        ...
        info_text = QLabel(
            "* Diese Regeln werden zur Laufzeit für Response-Generierung verwendet\n"
            "* Statistiken zeigen, wie oft jede Regel angewendet wurde\n"
            "* Utility × Specificity = Priorität für Conflict Resolution"
        )
        info_text.setWordWrap(True)
    ...
    def show_rule_details(self, item):
        """Zeigt Details für ausgewählte Regel."""
        ...
        <body>
            ...
            <div class="field">
                <span class="label">Priorität (Utility × Specificity):</span>
            ...
            <div class="field">
                ...
                <span class="value">{rule.metadata.get('description', 'Keine Beschreibung verfügbar')}</span>
            </div>
        </body>
        </html>
        """
    ...
    def refresh_stats(self):
        """
        Lädt Stats aus Neo4j neu und aktualisiert die UI (PHASE 9).
        """
        if not self.netzwerk:
            return
    ...
    def get_settings(self) -> dict:
        """Gibt aktuelle Einstellungen zurück"""
        return {}  # Keine persistenten Settings für Production System Tab
...
class SettingsDialog(QDialog):
    ...
    def init_ui(self):
        ...
        self.tab_widget.addTab(self.production_tab, "⚙️ Production System")
